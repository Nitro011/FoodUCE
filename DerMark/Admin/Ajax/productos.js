    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#datatableProductos').DataTable({
                ...
                columns: [
                    { 'data': 'nombres_productosv' },
                    { 'data': 'cantidadv' },
                    { 'data': 'unidadMedidastrv' },
                    { 'data': 'costov' },
                    { 'data': 'precio_ventasv' },
                    { 'data': 'descripcionv' },
                    { 'data': 'estadov' },
                    {
                        'data': 'fecha_entradav', 'render': function (d) {
...
function registrar_producto() {
    ...
    if (nombre_productov == "") {
        ...
        var value = { nombreProducto: nombre_productov, cantidad: cantidadv, unidad_de_medida: unidad_de_medidav, descripcion: descripciov, costo: costov, precio_ventas: precio_ventav, fentradav: fEntrada };
